    ...
    <div class="container h-100">
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
            ...
            <H2><center>Seller Policy</center></H2>
                <form method="POST" action="{{route('sellerPolicy.update')}}">
                @csrf
                <div class="form-outline mb-1">
                        <label class="form-label" for="form3Example1cg">Title</label>
                        <input type="text" id="form3Example1cg" class="form-control" value="{{$sellerPolicesDetail['title']}}" disabled>
                </div>
              ...
              <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" disabled>@php
                {{
                    print($sellerPolicesDetail['description']);
                }}
                @endphp</textarea>
              </div>
                
              <div class="form-outline mb-1">
                        <label class="form-label" for="form3Example1cg">Seller Policy ID</label>
                        <input type="text" id="form3Example1cg" class="form-control" value="{{$sellerPolicesID}}" name="sellerPolicesID" readonly="readonly">
                </div>
                ...
                <div class="form-group">
                        ...
                        <select class="form-control" id="exampleFormControlSelect1" name="statusDD">
                            @php
                            {{
                                if($sellerPolicesDetail['status'] == 1){
                            @endphp            
